...
//                [imageView sd_setImageWithURL:_urlArray[_imgCount-1] ];
                [imageView sd_setImageWithURL:_urlArray[_imgCount-1] placeholderImage:[UIImage imageNamed:@"首页banner默认"]];
            ...
            if (_hasUrlImg) {
                [imageView sd_setImageWithURL:_urlArray[0] placeholderImage:[UIImage imageNamed:@"首页banner默认"]];
            }else{
            ...
            if (_hasUrlImg) {
                [imageView sd_setImageWithURL:_urlArray[i-1] placeholderImage:[UIImage imageNamed:@"首页banner默认"]];
            }else{
