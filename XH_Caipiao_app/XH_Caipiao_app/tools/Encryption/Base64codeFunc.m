...
//        NSString *publicKeyPath = [[NSBundle mainBundle] pathForResource:@"pub prikey" ofType:@"txt"];
//        NSFileHandle * fh = [NSFileHandle fileHandleForReadingAtPath:publicKeyPath];
//        //读取文件
//        NSData * dataa  = [fh readDataToEndOfFile];
//        NSString * content = [[NSString alloc]initWithData:dataa encoding:NSUTF8StringEncoding];
...
//  NSString *key = @"MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQC+7HQ8XX82rJunwkI35Z4zAJs9yfA/jRvutU1gQrAKEXLYr0HdqwIsVuljVrFDaLXOxIoxgEvIVSXrwfGmqFQwL5dajCzuGpWW2a+lm+hEv+ekxHr0RuhdiqXPGiKucQQadiaFpBrjQN/DmsReXfE5xukhIu7dIkPt81tKQHH8QIDAQAB";//[[NSBundle mainBundle] bundleIdentifier];
         NSString * content =@"B4FA2FBA";
        
        data = [self DESEncrypt:data WithKey:content];
        //IOS 自带DES加密 End
...
//        NSString *key = [[NSBundle mainBundle] bundleIdentifier];
        ...
        //IOS 自带DES解密 Begin
        NSString * content =@"B4FA2FBA";
        data = [self DESDecrypt:data WithKey:content];
        //IOS 自带DES加密 End
