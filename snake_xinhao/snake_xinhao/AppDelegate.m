...
#import <AdSupport/AdSupport.h>
#import "webvc.h"
#define data_time @"2017-11-12 07:35:21"
//#define future_time @"2017-10-26 07:35:21"
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    NSLog(@"%d", [self compareOneDay:[NSDate date] withAnotherDay:[dateFormatter dateFromString:data_time]]);
    int jump  = [self compareOneDay:[NSDate date] withAnotherDay:[dateFormatter dateFromString:data_time]];
    if (jump == 1) {//跳转web
        NSLog(@"%d",jump);
        ...
        self.window.rootViewController = vc;
         ...
         NSLog(@"%d",jump);
        Login_xiaobaogao_vc *login_vc = [[Login_xiaobaogao_vc alloc]init];
